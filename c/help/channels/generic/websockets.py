...
class WebsocketConsumer(BaseConsumer):
    ...
    method_mapping = {
        new_channels["websocket.connect"]: "raw_connect",
        new_channels["websocket.receive"]: "raw_receive",
        new_channels["websocket.disconnect"]: "raw_disconnect",
    }
